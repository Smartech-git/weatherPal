    ...
    return (
            <div className="SearchBarContainer" style={{backgroundColor: state.themeHue.primary}}>
                ...
                <div style={{backgroundColor: state.themeHue.primary_light}}  className="SearchBar">
                    ...
                    <input  style={{backgroundColor: state.themeHue.primary_light }}  className={`SearchInput PlaceHolder-${state.theme}`} onChange={(e)=> setValue(e.target.value)} value={value} placeholder="Type any word here..."  spellCheck='false' type="text"/>
                    <div className='SearchRipple'>
                        <Ripples color={'rgba(0,0,0, 0.15)'}>
                            <div  className={`SearchButton SearchBarIcons-${state.theme}`} style={{backgroundColor: state.themeHue.primary}}>
